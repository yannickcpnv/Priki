    ...
    <x-breeze.auth-card>
        ...
        <!-- Name -->
            <div>
                ...
                <x-breeze.input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')"
                                required
                                autofocus/>
            </div>
            ...
            <div class="mt-4">
                ...
                <x-breeze.input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')"
                                required/>
            </div>
